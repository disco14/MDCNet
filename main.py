...
parser.add_argument('--model', default='mynet', help='select a model structure', choices=__models__.keys())
parser.add_argument('--maxdisp', type=int, default=192, help='maximum disparity')

parser.add_argument('--dataset', required=True, default='sceneflow', help='dataset name', choices=__datasets__.keys())
parser.add_argument('--datapath', required=True,  default="/home/jiaxiaogang/research/dataset/SceneFlow/", help='data path')
parser.add_argument('--test_dataset', required=True, default='sceneflow', help='dataset name', choices=__datasets__.keys())
parser.add_argument('--test_datapath', required=True, default="/home/jiaxiaogang/research/dataset/SceneFlow/", help='data path')
parser.add_argument('--trainlist', required=True, default='./filenames/sceneflow_train.txt', help='training list')
parser.add_argument('--testlist', required=True, default='./filenames/sceneflow_test.txt', help='testing list')

parser.add_argument('--lr', type=float, default=0.001, help='base learning rate')
parser.add_argument('--batch_size', type=int, default=8, help='training batch size')
parser.add_argument('--test_batch_size', type=int, default=4, help='testing batch size')
parser.add_argument('--epochs', type=int, required=True, default=16, help='number of epochs to train')
parser.add_argument('--lrepochs', type=str, required=True, default="12:2", help='the epochs to decay lr: the downscale rate')
...
parser.add_argument('--dlossw', type=str, default="1.0", help='depth loss weight for different stage')
...
if args.resume:
    ...
    # pretrained_dict = {k: v for k, v in state_dict.items() if k in net2_dict}
...
if is_distributed:
    ...
    TrainImgLoader = torch.utils.data.DataLoader(train_dataset, args.batch_size, sampler=train_sampler, num_workers=4,
                                                 drop_last=True, pin_memory=True)
    TestImgLoader = torch.utils.data.DataLoader(test_dataset, args.test_batch_size, sampler=test_sampler, num_workers=4,
